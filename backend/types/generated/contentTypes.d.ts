...
export interface ApiKategoriKategori extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    aspirasis: Schema.Attribute.Relation<
      'manyToMany',
      'api::aspirasi.aspirasi'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    > &
      Schema.Attribute.Private;
    nama: Schema.Attribute.Enumeration<['Siswa', 'Guru', 'Fasilitas']>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSiswaSiswa extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    aspirasis: Schema.Attribute.Relation<'oneToMany', 'api::aspirasi.aspirasi'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::aspirasi.aspirasi': ApiAspirasiAspirasi;
